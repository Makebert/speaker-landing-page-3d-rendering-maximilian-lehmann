...
export default function ScrollSection() {
  ...
  return (
    <section id="topics" className="relative bg-black text-white scroll-mt-20">
      ...
      <div className="absolute md:sticky top-0 left-0 w-full h-full md:h-screen overflow-hidden z-0 rounded-3xl md:rounded-none">
      ...
      {/* Content */}
      <div className="relative z-20 max-w-7xl mx-auto px-6 mt-0 md:-mt-[100vh] py-16 md:py-0">
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-1/2 md:h-screen md:sticky md:top-0 flex flex-col justify-center pr-0 md:pr-12 z-20 md:bg-transparent bg-black/60 backdrop-blur-md md:backdrop-blur-none rounded-2xl md:rounded-none p-6 md:p-0 mb-12 md:mb-0">
          ...
          <div className="w-full md:w-1/2 py-4 md:py-[50vh] relative z-10">
            <div className="flex flex-col gap-12 md:gap-[30vh]">
              {topics.map((topic, i) => (
                <h3
                  key={i}
